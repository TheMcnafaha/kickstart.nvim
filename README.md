...
* run: `git clone https://github.com/nvim-lua/kickstart.nvim.git ~/.config/nvim` OR: `gh repo clone nvim-lua/kickstart.nvim` if you want the og kickstart setup. For this version of kickstart run: 'git clone https://github.com/TheMcnafaha/kickstart.nvim ~/.config/nvim'
